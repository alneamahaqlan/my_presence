...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ApiError apiError) failure,
  }) => throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(ApiError apiError)? failure,
  }) => throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$FailureImpl<T> implements Failure<T> {
  const _$FailureImpl(this.apiError);
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure(final ApiError apiError) = _$FailureImpl<T>;
