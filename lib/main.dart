  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => getIt<HomeBloc>()..add(const HomeEvent.getFaculties())),
        BlocProvider(create: (context) => getIt<MemberBloc>()..add(const MemberEvent.loadMembers())),
        ...
        BlocProvider(create: (context) => ThemeBloc()), // Add ThemeBloc
      ],
